...
if __name__ == "__main__":
    quicBundlesX = QuickBundlesXAlgo(trkPath="/scratch/mahirj.scee.iitmandi/Gagan/SlicerTracto/sample.trk", segmentedTrkFolderPath="/scratch/mahirj.scee.iitmandi/Gagan/SlicerTracto/Segment/SegmentTrks")
    quicBundlesX.run()