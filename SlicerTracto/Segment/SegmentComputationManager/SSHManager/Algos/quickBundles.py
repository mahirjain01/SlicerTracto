...
if __name__ == "__main__":
    quicBundles = QuickBundlesAlgo(trkPath="/scratch/mahirj.scee.iitmandi/Gagan/SlicerTracto/sample.trk", segmentedTrkFolderPath="/scratch/mahirj.scee.iitmandi/Gagan/SlicerTracto/Segment/SegmentTrks")
    quicBundles.run()
