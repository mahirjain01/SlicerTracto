...
#
# SecondModuleParameterNode
#


@parameterNodeWrapper
class SecondModuleParameterNode:
    """
...
class SecondModuleWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
    ...
    def setup(self) -> None:
        ...
        self.ui.saveTrkButton.connect("clicked(bool)", self._tractographyParams.saveTrk)
    ...
    def setParameterNode(self, inputParameterNode: Optional[SecondModuleParameterNode]) -> None:
        """
...
class SecondModuleLogic(ScriptedLoadableModuleLogic):
    ...
    def getParameterNode(self):
        return SecondModuleParameterNode(super().getParameterNode())
...
class SecondModuleTest(ScriptedLoadableModuleTest):
    """
    ...
    def runTest(self):
        ...
        self.setUp()
        self.test_SecondModule1()

    def test_SecondModule1(self):
        ...
        registerSampleData()
        inputVolume = SampleData.downloadSample("SecondModule1")
