...
#
# FourthModuleParameterNode
#


@parameterNodeWrapper
class FourthModuleParameterNode:
    """
...
class FourthModuleWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
    ...
    def setParameterNode(self, inputParameterNode: Optional[FourthModuleParameterNode]) -> None:
        """
...
class FourthModuleLogic(ScriptedLoadableModuleLogic):
    ...
    def getParameterNode(self):
        return FourthModuleParameterNode(super().getParameterNode())
...
class FourthModuleTest(ScriptedLoadableModuleTest):
    """
    ...
    def runTest(self):
        ...
        self.setUp()
        self.test_FourthModule1()

    def test_FourthModule1(self):
        ...
        registerSampleData()
        inputVolume = SampleData.downloadSample("FourthModule1")
